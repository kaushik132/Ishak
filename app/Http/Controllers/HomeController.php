...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('home', compact('gallery', 'customers', 'customer', 'tour'));
    }
    ...
    $inclusions = Inclusions::latest()->get();
        ...
        //       $seo_data['seo_image'] = $tourData->image;
        //    $canocial ='https://www.tajindiatrails.com/blog/'.$slug;
        return view('tourdetails', compact('tourData','tourdetails','inclusions','exclusions','alltour'));
    }
