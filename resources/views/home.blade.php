...
@section('main.section')
    ...
    <section id="hero-section" class="hero-section px-7 lg:px-14">
        <div>
            <div>
                <h1 class="text-white heading font-semibold lg:text-[62px] text-[28px] text-center lg:w-[60%] mx-auto">
            ...
            <div class="mt-16 relative">
                <div class="flex justify-between">
                    <div class="w-[40%] hidden lg:block">
                        ...
                        <div class="flex gap-3 items-center mt-5">
                            <div class="flex border border-white py-1 px-1.5 rounded-[30px]">
                                <img class="w-8 rounded-full h-8 object-cover" src="./images/user-1.png" alt="" />
                                <img class="w-8 rounded-full h-8 -ml-2 object-cover" src="./images/user-2.png"
                                    alt="" />
                                <img class="w-8 rounded-full h-8 -ml-2 object-cover" src="./images/user-3.png"
                                    alt="" />
                                <img class="w-8 rounded-full h-8 -ml-2 object-cover" src="./images/user-4.png"
                                    alt="" />
                        ...
                        <div class="mt-8 flex gap-3 items-center">
                            <button class="bg-[#C4693AA6] px-7 pt-2.5 pb-3 rounded-[30px] text-white">
                                Book Now
                            </button>
                            <button class="h-11 rotate-[330deg] rounded-full w-11 border border-white">
                        ...
                        <div class="mt-8">
                            <ul class="flex justify-between text-white">
                                <li>
                                    <a href="#" class="text-[14px] font-semibold">+91 987689969</a>
                                </li>
                                <li>
                                    <a href="#" class="text-[14px] font-semibold">Ishak@gmail.com</a>
                                </li>
                                <li>
                                    <a href="#" class="text-[14px] font-semibold">24-B-2, Jay colony, jay singh pura
                                        khor,</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div id="heroSlider" class="swiper w-full lg:w-[45%] m-0 h-[300px] -mr-12">
                        <div class="swiper-wrapper">
                            <!-- Slide 1 -->
                            @foreach ($gallery as $galleries)
          
                            <div class="swiper-slide w-[23%] group">
                                <img class="h-[260px] group-[.swiper-slide-active]:h-[170px] transition-all duration-300 object-cover rounded-lg"
                                    src="{{url('uploads/'.$galleries->image)}}" alt="{{$galleries->alt}}" />
                ...
                <div class="w-[100%] lg:w-[42%] h-[5px] right-0 bg-[#777] rounded-full -mt-8 absolute overflow-hidden">
                    <div id="progress-bar" class="h-full w-[33.33%] bg-[#A95C32] transition-all duration-500 rounded-full">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="jaipurHeritageSection px-7 lg:px-14">
        <div class="text-center">
            <button class="bg-[#A95C32] text-white px-4 py-1 rounded-[30px] text-[10px] lg:text-[13px]">
                Destination
            </button>
                    ...
                    <div class="flex justify-between items-end">
                        <div>
                            ...
                            <div class="flex gap-3 items-center mt-4">
                                <div class="flex border border-white py-1 px-1.5 rounded-[30px]">
                                    <img class="w-8 rounded-full h-8 object-cover" src="./images/user-1.png"
                                        alt="" />
                                    <img class="w-8 rounded-full h-8 -ml-2 object-cover" src="./images/user-2.png"
                                        alt="" />
                                    <img class="w-8 rounded-full h-8 -ml-2 object-cover" src="./images/user-3.png"
    ...
    <section class="whyChooseUsSection px-7 lg:px-14">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-5">
            <div class="col-span-1">
                <div class="bg-[#F9F9F9] border border-[#CFCFCF] rounded-[16px] pt-6 pb-12 px-7">
                    <div class="shadow-lg bg-[#A95C32] h-[80px] w-[80px] flex justify-center items-center rounded-full">
    ...
    <section class="gallerySection px-7 lg:px-14 my-14">
        <div class="text-center">
            ...
            <div class="text-right mb-3">
                <a href="./gallery.html" class="font-semibold text-[#A95C32]">Explore More</a>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div class="col-span-1">
                <div class="relative">
                    <img class="rounded-[16px] gallery-img cursor-pointer lg:h-[470px] object-cover" data-index="0"
                        src="./images/royal-gaitor.jpg" alt="" />

                    <span class="absolute top-4 right-4 text-[13px] font-semibold px-3 py-1 rounded-[30px] bg-white">Royal
                        Gaitor</span>
                </div>
                <div class="relative">
                    <img class="rounded-[16px] gallery-img cursor-pointer object-cover mt-4" data-index="1"
                        src="./images/royal-gaitor.jpg" alt="" />
                    <span class="absolute top-4 right-4 text-[13px] font-semibold px-3 py-1 rounded-[30px] bg-white">Jal
                        Mahal</span>
                </div>
            </div>
            ...
            <div class="col-span-1">
                <div class="flex gap-4">
                    <div>
                        <div class="relative">
                            <img class="lg:h-[265px] h-[150px] cursor-pointer w-[190px] lg:w-[360px] object-cover rounded-[16px] gallery-img"
                                data-index="2" src="./images/architecturel-city-palace.jpg" alt="" />
                            <span
                                class="absolute top-4 right-4 text-[13px] font-semibold px-3 py-1 rounded-[30px] bg-white">Amer
                                Fort</span>
                        </div>

                        <div class="relative">
                            <img class="lg:h-[265px] h-[150px] cursor-pointer w-[190px] lg:w-[360px] object-cover mt-4 rounded-[16px] gallery-img"
                                data-index="3" src="./images/hawa-mahal.jpg" alt="" />
                            <span
                                class="absolute top-4 right-4 text-[13px] font-semibold px-3 py-1 rounded-[30px] bg-white">Hawa
                                Mahal</span>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="relative">
                            <img class="lg:h-[545px] gallery-img cursor-pointer lg:w-[320px] w-[200px] h-[316px] object-cover rounded-[16px]"
                                src="./images/patrika-gate.jpg" alt="" data-index="4" />
                            <span
                                class="absolute top-4 right-4 text-[13px] font-semibold px-3 py-1 rounded-[30px] bg-white">Patrika
                                Gate</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    <div class="relative">
                        <img class="w-full gallery-img h-[200px] cursor-pointer lg:h-[313px] object-cover rounded-[16px]"
                            src="./images/architecturel-city-palace.jpg" data-index="5" alt="" />
                        <span
                            class="absolute top-4 right-4 text-[13px] font-semibold px-3 py-1 rounded-[30px] bg-white">Pnna
                            Minakund</span>
                    </div>
                </div>
            </div>
